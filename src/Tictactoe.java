...
// Change player marks back and forth.
    ...
    public void printWinner() {
    	if (currentPlayer == 'X' && (checkForWin())) {
    		 System.out.print("You");
    		
    	}
    	else if  (currentPlayer == 'O' && (checkForWin())) {
    ...
    public void ComputerPlay(){
	     ...
	     String kinisi="";
			switch(y){
			case(0): kinisi = "A" ; break; 
			case(1): kinisi = "B" ; break;
			case(2): kinisi = "C"; break;
			}
			
			int k = x + 1;
		     kinisi = kinisi + Integer.toString(k);
		     
		
			System.out.println("Computer playing at: " + kinisi);
			System.out.println();
